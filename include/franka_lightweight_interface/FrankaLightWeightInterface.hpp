...
namespace frankalwi
{
    ...
    public:
         ...
         */
        explicit FrankaLightWeightInterface(const std::string & robot_ip);
    ...
    inline void FrankaLightWeightInterface::print_state() const
    {
        ...
        std::cout << this->current_cartesian_orientation_.w() << ", " << this->current_cartesian_orientation_.vec().transpose() << std::endl;
